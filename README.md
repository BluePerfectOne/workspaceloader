...
For full development environment setup, reproducible configure/build rehearsal steps, and troubleshooting, see [doc/docs/development-environment.md](doc/docs/development-environment.md).
